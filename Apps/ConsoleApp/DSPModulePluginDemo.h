...
//==============================================================================
class DspModulePluginDemo : public juce::AudioProcessor,
...
private:
    ...
    using Chain = juce::dsp::ProcessorChain<dsp::NoiseGate<float>,
                                      dsp::Gain<float>,
                                      DirectDelayProcessor,
                                      MultiBandProcessor,
...
//==============================================================================
class DspModulePluginDemoEditor final
...
public:
          ...
          proc (p)
    {
        ...
        comboEffect.setSelectedId (proc.indexTab + 1, juce::dontSendNotification);
        ...
        addAllAndMakeVisible (*this,
                              ...
                              chorusControls,
                              ladderControls);
        labelEffect.setJustificationType (juce::Justification::centredRight);
    ...
    void paint (juce::Graphics& g) override
    {
        ...
        g.drawFittedText ("DSP MODULE DEMO", rectTop.reduced (10, 0), juce::Justification::centredLeft, 1);

        g.setFont (juce::Font (14.0f));
        juce::String strText = "IR length (reverb): " + juce::String (proc.getCurrentIRSize()) + " samples";
        g.drawFittedText (strText, rectBottom.reduced (10, 0), juce::Justification::centredRight, 1);
    }
...
private:
    ...
    {
    public:
        ComponentWithParamMenu (AudioProcessorEditor& editorIn, juce::RangedAudioParameter& paramIn)
    ...
    {
    public:
        AttachedSlider (AudioProcessorEditor& editorIn, juce::RangedAudioParameter& paramIn)
...
struct DspModulePluginDemoAudioProcessor final
    : public DspModulePluginDemo
{
