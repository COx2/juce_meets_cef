...
void CefSimpleApp::OnContextInitialized()
{
    ...
    CefRefPtr<CefSimpleHandler> handler(new CefSimpleHandler(use_views));
...
CefRefPtr<CefClient> CefSimpleApp::GetDefaultClient()
{
  // Called when a new browser window is created via the Chrome runtime UI.
  return CefSimpleHandler::GetInstance();
}
